...
#register_command_handler(handler_deadline, '!dl', ['admin','all'], 20, 'Displays the number of days till deadline.', '!dl', ['!dl'])
...
#register_command_handler(handler_deadline_list, '!dl_list', ['superadmin','all'], 100, 'Displays all registered deadlines.', '!dl_list', ['!dl_list'])
...
#register_command_handler(handler_deadline_delete, '!dl_del', ['superadmin','all'], 100, 'Removes deadline with specified ID.', '!dl_del id', ['!d1_del 0', '!dl_del 5'])
...
#register_command_handler(handler_deadline_add, '!dl_add', ['superadmin','all'], 100, 'Adds new deadline.', '!dl_add yyyy-mm-dd message', ['!dl_add 2008-05-09 Victory'])
