...
register_command_handler(handler_dns_dns, 'dnsx', ['info','all'], 10, 'Shows an answer from DNS for a certain host or IP of address.', 'dnsx <host/IP>', ['dnsx id.jsmart.web', 'dnsx 121.52.132.84'])
