...
#        
#        file='dynamic/'+groupchat+'/userslog.log'
...
#                                        spar = par[1]
#                
#        file='dynamic/'+source[1]+'/userslog.log'
...
#        global timeroff
#        timeroff = parameters
#        file='dynamic/'+source[1]+'/timercomm.cfg'
...
#        global GLOBGREETS
#
#        GLOBGREETS = eval(read_file('dynamic/globgreet.txt'))
#
#        jid = get_true_jid(groupchat+'/'+nick)
#        jid1 = jid.lower()
#
...
#                write_file('dynamic/globgreet.txt', str(GLOBGREETS))
