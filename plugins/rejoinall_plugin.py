...
register_command_handler(handler_changestatus, 'setstatus', ['muc','admin','all'],20, 'Change bot status in the current conference, if two parameters are not mentioned, bots will use the default status.', 'setstatus[online|chat|away|xa|dnd] [message]', ['setstatus chat','setstatus dnd','setstatus away meeting!!','setstatus'])
